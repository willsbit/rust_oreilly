...
// we’ll treat these as the x and y coordinates of a point on the Cartesian plane,
// and color the point black if c is in the Mandelbrot set, or a lighter color otherwise
...
fn main() {
...

    {
        let bands: Vec<&mut [u8]> = pixels
            .chunks_mut(rows_per_band * bounds.0).collect();
...
pub mod test {
    ...
    use crate::{Complex, parse_complex, parse_pair, pixel_to_point};
